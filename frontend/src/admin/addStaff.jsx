...
<p className="font-bold">Specifications</p>
  ...
  <div className="flex items-center mb-3 bg-white rounded mr-2">
    ...
    <br></br>
    <button className="py-4 px-6 bg-black hover:bg-black-600 text-white font-bold rounded transition duration-200" disabled={loading} type="submit" onClick={handleSubmit}>{loading ? 'Loading...' : 'Add Staff'}</button>
  </form>
    </div>
    </>
  )
