...
const StaffProfile = (props) => {
  ...
  const url =
    env === "production"
      ? "https://placement-tracker-swart.vercel.app/staff/" + params.staff
      : "http://localhost:5000/staff/" + params.staff;
        ...
        <form className=" lg:py-0 py-1  grid justify-center" action="#">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2   mb-3 ">
            <div>
              ...
              <div className="flex items-center mb-3 shadow-lg shadow-white rounded mr-2">
                <p
                  className="w-auto pl-4 pr-6 py-4 font-bold rounded  focus:outline-none "
                  id="name"
                >
                  {profile.name}{" "}
                </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2  mb-3 ">
            <div>
              ...
              <div className="flex items-center mb-3 shadow-lg shadow-white rounded mr-2">
                <p
                  className="w-full  pl-4 pr-6 py-4 font-bold rounded  focus:outline-none shadow-lg shadow-white"
                  id="role"
                >
                  {profile.job}
                </p>
