  ...
  <div className="flex items-center mb-3 ">
      ...
      <div>
          ...
          <div className="flex items-center mb-3 bg-white rounded mr-2">
            ...
            <input className="w-full  pl-4 pr-6 py-4 font-bold rounded  focus:outline-none bg-white" id="dept" name="dept" onChange={handleChange} type="text" placeholder="department" />
          </div>
        </div>
...
<p className="font-bold">Specifications</p>
  ...
  <div className="flex items-center mb-3 ">
      <div>
        ...
        <div className="flex items-center mb-3 bg-white rounded mr-2">
          ...
          <input className="w-full  pl-4 pr-6 py-4 font-bold rounded  focus:outline-none bg-white" id="roll" name="roll" onChange={handleChange} type="text" placeholder="roll no" />
        </div>
      </div>
      <div>
 ...
 <br></br>
    ...
    <button className="py-4 px-6 bg-black hover:bg-black-600 text-white font-bold rounded transition duration-200" disabled={loading} type="submit" onClick={handleSubmit}>{loading ? 'Loading...' : 'Add Student'}</button>
  </form>
    </div>
    </>
  )
