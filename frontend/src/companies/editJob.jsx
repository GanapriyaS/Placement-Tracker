      ...
      const url =
        env === "production"
          ? "https://placement-tracker-swart.vercel.app/company/" +
            ...
            "/job/" +
            job.id
          : "http://localhost:5000/company/" + msg + "/job/" + job.id;
          ...
          <div className="flex items-center mb-3 ">
            <div className="mr-2">
              ...
              <div className="dropdown  w-full mb-3 flex items-center  rounded mr-2">
                <select
                  className="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-900 rounded focus:outline-none bg-gray-100"
                  required
                  name="type"
                  id="type"
                  onChange={handleChange}
