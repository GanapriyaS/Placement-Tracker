...
const EditCompaniesProfile = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const { name, description, department, pack, website, email, phoneno } =
      company;
    ...
    if (
      ...
      const url =
        env === "production"
          ? "https://placement-tracker-swart.vercel.app/company/" + company.id
          : "http://localhost:5000/company/" + company.id;
          ...
          <div className="flex items-center mb-3 ">
            <div className="flex items-center mb-3 ">
              ...
              <div>
                ...
                <div className="flex items-center mb-3 bg-white rounded mr-2">
                  <textarea
                    className="w-full  pl-4 pr-6 py-1 font-bold rounded resize-y rounded-md focus:outline-none bg-white"
                    row="1"
                    id="description"
