...
const Recruiters = () => {
  ...
  const url =
    env === "production"
      ? "https://placement-tracker-swart.vercel.app/alljobs"
  ...
  return (
    <>
      {open && (
        <main class="antialiased bg-opacity-50 fixed bg-gray-200 text-gray-900 font-sans w-full  overflow-x-hidden">
              ...
              <div class="md:flex items-center">
                ...
                <div class="mt-4 md:mt-0 md:ml-6 text-center md:text-left">
                  ...
                  <p class="text-sm text-gray-700 mt-1">
                    Your data will be recorded and sent to the company for
                    futhur rounds
                  </p>
                </div>
              </div>
            ...
            <tbody>
              {/* <tr className="text-black">
                ...
                <td className="px-5 py-3 border-b border-gray-200 text-red-500 text-sm line-through">
                  <input
                    className=" px-1 py-2 font-bold rounded  focus:outline-none bg-white"
                    id="name"
                    type="search"
              ...
              {jobs.map((job, index) => {
                ...
                return (
                  <tr className="bg-gray-600 text-gray-200" key={id}>
                    ...
                    <td className="px-5 py-5 border-b border-gray-200  text-sm">
                      <p className="whitespace-no-wrap">{lastdate}</p>
                    </td>
                    ...
                    <td className="px-5 py-5 border-b border-gray-200 text-sm ">
                      <p
                        ...
                        onClick={() => openConfirmationModal(companyname, id)}
                      >
