...
const StudentProfile = (props) => {
  ...
  const url =
    env === "production"
      ? "https://placement-tracker-swart.vercel.app/student/" + params.student
      : "http://localhost:5000/student/" + params.student;
    ...
    <>
      <div className="w-full h-full p-4  mt-8 overflow-y-auto ">
        <div className="flex justify-around ">
          ...
          {params.student === msg && kind === "student" && (
            <div className="grid lg:flex">
              <Link
                className="py-3 px-4 mr-1 w-full bg-black hover:bg-black-600 text-white font-bold rounded transition duration-200"
                to="/student/appliedjobs"
              >
                View&nbsp;appliedjobs
              </Link>
              <Link
                className="py-3 px-4 w-full bg-black hover:bg-black-600 text-white font-bold rounded transition duration-200"
        ...
        <form className=" lg:py-0 py-5  grid justify-center" action="#">
          ...
          <div className="flex items-center mb-3 ">
            ...
            <div>
              ...
              <div className="flex items-center mb-3 rounded mr-2 shadow-lg shadow-white rounded">
                <p className="w-full  pl-4 pr-6 py-4 font-bold rounded  focus:outline-none">
                  {profile.batch}
                </p>
              </div>
            </div>
